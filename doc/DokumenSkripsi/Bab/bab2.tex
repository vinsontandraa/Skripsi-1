...
\subsection{Penjelasan Pada Jurnal \textit{Measuring Unsupported Applications in Indonesia Popular Websites}\cite{pascal}}
...
\begin{table}[H]
	...
	\begin{tabular}{rlcccc} 
		...
		\hline
\end{tabular}
\caption{First ten result of measurement}
...
\begin{table}[H]
	...
	\begin{tabular}{rccccc} 
		...
		\textbf{rank} & \textbf{r=0} & \textbf{r=1} & \textbf{r=2} & \textbf{r=3} & \textbf{r=4}\\
			...
			\hline
		\end{tabular}
		\caption{Number of unsupported applications grouped by website rank}
