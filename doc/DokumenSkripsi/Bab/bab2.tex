...
\end{itemize}
Di dalam HTTP Archive terdapat dataset yang dapat diambil menggunakan teknologi BigQuery. Dataset dari HTTP Archive masih kotor sehingga terdapat beberapa data yang ganda dan terdapat versi dari aplikasi yang tidak dapat ditentukan (hanya berisi karakter atau simbol).
...
\begin{enumerate}
	...
	\caption{\textit{ Algorithm to compare current version versus supported versions Algoritma untuk membandingkan versi yang dipakai dengan versi yang masih didukung}} 
	\label{fig:apr} 
\end{figure}
\end{enumerate}
...
\end{tabular}
\caption{Overall application count for measurement result Jumlah keseluruhan aplikasi berdasarkan hasil pengukuran}
\label{table:apr}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{rlcccc} 
		...
		\hline
\end{tabular}
\caption{First ten result of measurement Sepuluh Hasil Pengukuran}
...
\begin{table}[H]
	...
	\begin{tabular}{rccccc} 
		...
		\textbf{rank} & \textbf{r=0} & \textbf{r=1} & \textbf{r=2} & \textbf{r=3} & \textbf{r=4}\\
			...
			\hline
		\end{tabular}
		\caption{Number of unsupported applications grouped by website rank Jumlah aplikasi yang tidak didukung berdasarkan rank website}
...
\begin{table}[H]
	...
	\begin{tabular}{rlcccc} 
		...
		\hline
	\end{tabular}
	\caption{Top applications used Aplikasi yang Banyak Digunakan}
