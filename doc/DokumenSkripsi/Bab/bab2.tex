...
Berikut ini adalah contoh sintaks ReactJS:
\begin{lstlisting}
...
\subsection{NPX}
NPX merupakan \textit{execute NPM package binaries.}. NPX digunakan untuk menjalan \textit{command} yang dimiliki NPM. NPX mengeksekusi file \textit{binary} dari \textit{package} \textit{Node.js}, baik yang sudah terinstal maupun yang belum.
