...
\begin{enumerate}
	...
	\begin{figure}[H]
		\centering  
		\includegraphics[scale=0.45]{Gambar/Google BigQuery HomePage.PNG}  
	...
	\begin{figure}[H]
		\centering  
		\includegraphics[scale=0.45]{Gambar/create_new_project.PNG}  
	...
	\begin{figure}[H]
		\centering  
		\includegraphics[scale=0.45]{Gambar/bq_workspace.PNG}  
		\caption{Membuka \textit{Console}} 
		\label{fig:create_project} 
	\end{figure}
	
	\item Untuk menambahkan tabel HTTP Archive pada \textit{project} didapatkan dari link \footnote{https://console.cloud.google.com/bigquery?p=httparchive\&d=httparchive\&page=dataset}
